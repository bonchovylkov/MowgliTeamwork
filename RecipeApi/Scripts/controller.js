...
var controllers = (function () {
	...
	var Controller = Class.create({
		...
		updateUI: function (selector) {
			this.persister.recipe.getAll(function (recipies) {
			    var list = ui.recipiList(recipies);
			    $(selector + " #allRecipies")
					.html(list);
			});
			this.persister.recipe.getByUser(function (recipies) {
			    var list = ui.recipiesByUser(recipies);
			    $(selector + " #userReps")
					.html(list);
			});
